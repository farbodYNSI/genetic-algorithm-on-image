...
def showAndSave(iter , resultPop,originalImg):
    ...
    result = result.reshape((imageWidth,imageHeight))
...
for iteration in range(maxIter):
    ...
    if iteration == 100 or iteration == 1000  or iteration ==5000 or iteration ==10000 or iteration ==20000:
        showAndSave(iteration,population,image)
else:
